# Industry: CMS — Consulting & Management Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 3 · **DMO Mode:** BALANCED · **Min STL to list:** L1 · **Industry Multiplier:** 1.0×

## 1. Description

Business consulting, strategy, management

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Consulting authority |
| Master | Regional consulting |
| Corporate | Consulting firms |
| Sub | Independent consultants |
| Micro | Advisors |
