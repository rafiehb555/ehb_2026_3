# Industry: ITS — Industrial Technology Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** BALANCED · **Min STL to list:** L2 · **Industry Multiplier:** 1.3×

## 1. Description

Industrial solutions, automation, IoT · enterprise tech

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Tech control |
| Master | Regional IT hubs |
