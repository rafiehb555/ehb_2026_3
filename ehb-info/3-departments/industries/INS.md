# Industry: INS — Insurance Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 3 · **DMO Mode:** CRITICAL · **Min STL to list:** L3 · **Industry Multiplier:** 2.0×

## 1. Description

Insurance products, claims, underwriting · regulated

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Insurance authority |
| Master | Regional insurance network |
