# Industry: RES — Real Estate Services (Expanded)
...
Construction, property development, leasing · large-scale real estate

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | National property authority |
| Master | Regional developers |
