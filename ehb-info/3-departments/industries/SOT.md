# Industry: SOT — Services of Technology

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** BALANCED · **Min STL to list:** L1 · **Industry Multiplier:** 1.3×

## 1. Description

Web + app dev, AI services, consulting · tech freelance

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Tech services authority |
| Master | Regional service hubs |
| Corporate | IT firms |
| Sub | Technicians |
| Micro | Repair freelancers |
