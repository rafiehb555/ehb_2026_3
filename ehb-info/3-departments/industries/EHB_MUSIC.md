# Industry: EHB_MUSIC — Music & Audio Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 2 · **DMO Mode:** BALANCED · **Min STL to list:** L1 · **Industry Multiplier:** 1.0×

## 1. Description

Musicians, producers, audio engineering

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Music authority |
| Master | Regional studios |
| Corporate | Labels / production cos |
| Sub | Studios |
| Micro | Independent musicians |
...
- Min STL to list: L1
- EHBGC lock: per industry multiplier 1.0×
- DMO mode: BALANCED
