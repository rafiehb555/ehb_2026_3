# Industry: MAS — Manufacturing & Assembly Services
...
Contract manufacturing, parts, assembly · B2B production

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Manufacturing authority |
| Master | Regional factories |
| Corporate | Manufacturers |
| Sub | Workshops |
| Micro | Skilled workers |
