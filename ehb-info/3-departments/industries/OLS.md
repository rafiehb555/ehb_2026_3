# Industry: OLS — Online Law Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** CRITICAL · **Min STL to list:** L3 · **Industry Multiplier:** 2.0×

## 1. Description

Legal consultation, case handling, contracts, AI Lawyer · jurisdiction-aware

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Legal network |
| Master | Regional law groups |
| Corporate | Law firms |
| Sub | Individual lawyers |
| Micro | Legal assistants |
