# Industry: CNS — Construction & Engineering Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 2 · **DMO Mode:** STRICT · **Min STL to list:** L2 · **Industry Multiplier:** 1.5×

## 1. Description

Builders, contractors, project management · regulated trade

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Construction authority |
| Master | Regional contractors |
| Corporate | Construction firms |
| Sub | Sub-contractors |
| Micro | Skilled tradespeople |
...
- STRICT mode = STRICT approval depth
...
- Min STL to list: L2
- EHBGC lock: per industry multiplier 1.5×
- DMO mode: STRICT
