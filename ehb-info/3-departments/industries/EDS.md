# Industry: EDS — Education & Development Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 2 · **DMO Mode:** BALANCED · **Min STL to list:** L1 · **Industry Multiplier:** 1.2×

## 1. Description

Skills training, vocational, tutoring

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Education authority |
| Master | Regional ed-tech |
| Corporate | Institutes |
| Sub | Coaching centers |
| Micro | Tutors |
