# Industry: HPS — Human Performance Solution

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** BALANCED · **Min STL to list:** L1 · **Industry Multiplier:** 1.2×

## 1. Description

Courses, certifications, fitness training, skill tracking · learning + wellness

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | National wellness authority |
| Master | Regional fitness network |
| Corporate | Gyms / institutes |
| Sub | Trainers / coaches |
| Micro | Freelance trainers |
...
- BALANCED mode = BALANCED approval depth
...
- Min STL to list: L1
- EHBGC lock: per industry multiplier 1.2×
- DMO mode: BALANCED
