# Industry: ELS — EHB Local Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** FAST · **Min STL to list:** L1 · **Industry Multiplier:** 1.0×

## 1. Description

Local services marketplace, handymen, tutors · neighborhood services

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Local services control |
| Master | City network |
