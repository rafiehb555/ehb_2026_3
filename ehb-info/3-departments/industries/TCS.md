# Industry: TCS — Telecom & Communication Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 2 · **DMO Mode:** BALANCED · **Min STL to list:** L2 · **Industry Multiplier:** 1.2×

## 1. Description

Telecom, ISP, communication solutions

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Telecom authority |
| Master | Regional telco network |
| Corporate | ISPs / Telcos |
| Sub | Resellers |
| Micro | Field technicians |
