# Industry: AGTS — Advanced Global Travel Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** BALANCED · **Min STL to list:** L1 · **Industry Multiplier:** 1.0×

## 1. Description

Tickets, hotels, travel packages, visas · cross-border bookings

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Travel authority |
| Master | Regional operators |
| Corporate | Travel agencies |
| Sub | Agents |
| Micro | Ticket resellers |
