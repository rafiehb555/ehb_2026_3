# Industry: GES — Gaming & Entertainment Services
...
Gaming platforms, tournaments, events

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Gaming authority |
| Master | Regional esports network |
| Corporate | Studios |
| Sub | Tournament organizers |
| Micro | Streamers |
