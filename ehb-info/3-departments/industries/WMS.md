# Industry: WMS — World Medical Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** CRITICAL · **Min STL to list:** L4 · **Industry Multiplier:** 2.0×

## 1. Description

Healthcare + telemedicine + AI Diagnosis (HIPAA-aligned, life-impact regulated)

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | National healthcare network |
| Master | City hospitals group |
| Corporate | Hospitals / labs |
| Sub | Clinics / pharmacies |
| Micro | Nurses / home service providers |
...
- CRITICAL mode = CRITICAL approval depth
...
- Min STL to list: L4
- EHBGC lock: per industry multiplier 2.0×
- DMO mode: CRITICAL
