# Industry: OBS — Online Book Store
...
Books + digital learning content + publisher network

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Content distribution |
| Master | Regional book hubs |
| Corporate | Publishers |
| Sub | Book sellers |
| Micro | Digital resellers |
