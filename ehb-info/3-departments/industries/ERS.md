# Industry: ERS — EHB Real Estate Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** STRICT · **Min STL to list:** L2 · **Industry Multiplier:** 1.5×

## 1. Description

Property buy/sell, rental, valuation · property network

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Property network |
| Master | City real estate heads |
| Corporate | Builders |
| Sub | Agents |
| Micro | Brokers |
