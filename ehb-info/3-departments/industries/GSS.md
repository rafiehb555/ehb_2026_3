# Industry: GSS — Green & Sustainable Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 2 · **DMO Mode:** BALANCED · **Min STL to list:** L1 · **Industry Multiplier:** 1.1×
...
| Tier | Role |
|---|---|
| Country | Green authority |
| Master | Regional sustainability hubs |
| Corporate | Green firms |
| Sub | Local installers |
| Micro | Green-tech installers |
...
- Min STL to list: L1
- EHBGC lock: per industry multiplier 1.1×
- DMO mode: BALANCED
