# Industry: FIN — Finance & Investment Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 2 · **DMO Mode:** CRITICAL · **Min STL to list:** L4 · **Industry Multiplier:** 2.0×

## 1. Description

Banking, loans, investment advisory · highly regulated

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Financial authority |
| Master | Regional finance hubs |
| Corporate | Banks |
| Sub | Advisory firms |
| Micro | Financial planners |
