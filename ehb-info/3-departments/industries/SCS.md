# Industry: SCS — Security & Cyber Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 3 · **DMO Mode:** CRITICAL · **Min STL to list:** L3 · **Industry Multiplier:** 1.5×

## 1. Description

Cybersecurity, physical security, consulting

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Security authority |
| Master | Regional security hubs |
| Corporate | Security firms |
| Sub | Local security cos |
| Micro | Analysts |
