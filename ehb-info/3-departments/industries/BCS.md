# Industry: BCS — Beauty & Cosmetics Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 2 · **DMO Mode:** FAST · **Min STL to list:** L1 · **Industry Multiplier:** 1.0×

## 1. Description

Salons, spas, beauty products

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Beauty authority |
| Master | City beauty network |
| Corporate | Salon chains |
| Sub | Salons |
| Micro | Makeup artists |
