# Industry: GSM — GoSellr (E-commerce)

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** FAST · **Min STL to list:** L1 · **Industry Multiplier:** 1.3×

## 1. Description

Main e-commerce + services marketplace · backbone of EHB

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | EHB Commerce Head |
| Master | City Warehousing + Distribution |
| Corporate | Big sellers / brands |
| Sub | Shops / resellers |
| Micro | Dropshippers / affiliate sellers |
...
- Min STL to list: L1
- EHBGC lock: per industry multiplier 1.3×
- DMO mode: FAST
