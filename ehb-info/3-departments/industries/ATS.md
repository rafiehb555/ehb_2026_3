# Industry: ATS — Automotive & Transportation Services
...
Car rentals, repairs, maintenance, sales

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Auto network |
| Master | Regional dealerships |
| Corporate | Auto firms |
| Sub | Workshops |
| Micro | Mechanics |
