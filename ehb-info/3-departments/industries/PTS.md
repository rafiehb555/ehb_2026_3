# Industry: PTS — Pets & Animal Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 2 · **DMO Mode:** BALANCED · **Min STL to list:** L2 · **Industry Multiplier:** 1.1×

## 1. Description

Veterinary, grooming, pet supplies

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Pet care authority |
| Master | City vet network |
| Corporate | Vet hospitals |
| Sub | Vet clinics |
| Micro | Pet handlers |
