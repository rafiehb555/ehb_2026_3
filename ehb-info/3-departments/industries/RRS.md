# Industry: RRS — Research & R&D Services

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 3 · **DMO Mode:** BALANCED · **Min STL to list:** L2 · **Industry Multiplier:** 1.2×

## 1. Description

Research, data analysis, innovation labs

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Research authority |
| Master | Regional research hubs |
| Corporate | Research firms |
| Sub | Independent labs |
| Micro | Researchers |
