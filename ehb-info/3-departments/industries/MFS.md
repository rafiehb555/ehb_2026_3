# Industry: MFS — Manufacturing & Food Safety

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 2 · **DMO Mode:** STRICT · **Min STL to list:** L3 · **Industry Multiplier:** 1.5×

## 1. Description

Food safety, QA, compliance, certification
...
| Master | Regional auditor network |
| Corporate | Audit firms |
| Sub | Local auditors |
| Micro | Quality auditors |
