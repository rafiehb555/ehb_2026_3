# Industry: EHB_TUBE — EHB Media Platform
...
Verified video sharing, content creators · EHB's YouTube alternative

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Content control |
| Master | Regional creators network |
| Corporate | Studios |
| Sub | Channels |
| Micro | Creators |
