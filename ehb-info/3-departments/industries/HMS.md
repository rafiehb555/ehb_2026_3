# Industry: HMS — Human Machinery Solutions

> **Status:** Canonical v1.0 · 2026-04-30
> **Tier:** Tier 1 · **DMO Mode:** BALANCED · **Min STL to list:** L2 · **Industry Multiplier:** 1.5×

## 1. Description

Machinery services, repair, maintenance · industrial equipment

## 2. Franchise hierarchy (5-tier)

| Tier | Role |
|---|---|
| Country | Industrial network |
| Master | Regional suppliers |
| Corporate | Factories |
| Sub | Workshops |
| Micro | Technicians |
